## Mr.Sudoku
### Why Did I Make This?
This project was important to me because I wanted to do more than just play Sudoku. I wanted to understand how computers solve Sudoku puzzles and why some puzzles are harder to solve than others. I also wanted to test my own solver and compare it to other solving methods, like basic backtracking and Peter Norvig’s solver.
### The Technology Stack
- Python 
- Tkinter
- 1M Kaggle Data Set by ***Kyubyong Park***‎
...
🔗 [Mr.Sudoku](https://ironant38.github.io/Mr.Sudoku/) 🔗
